        ...
        .row
          .col-5
            el-card.w-100.d-flex.justify-content-center(shadow="never")
              ...
              p.text-center.my-2 {{dataWallet[0].gameName}}
              p.text-center.my-2 {{dataWallet[0].Cash}}
          .col-2.text-center.d-flex.justify-content-center.flex-column.align-items-center.reverse(@click="selectWalletReverse")
            .icon.d-flex.justify-content-center.align-items-center.my-2(v-bind:class="[transOut ? 'active' : '']")
          ...
          .col-5
            el-card.w-100.d-flex.justify-content-center(shadow="never")
              ...
              p.text-center.my-2 {{dataWallet[1].gameName}}

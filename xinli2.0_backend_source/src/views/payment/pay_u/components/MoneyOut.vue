...
<script lang="ts">
  ...
  import { UcardMoneyOut } from '/@/api/payment/payU';
  import { BasicModal, useModalInner } from '/@/components/Modal';
  import { BasicForm, useForm } from '/@/components/Form';
  import { moneyOutSchemas } from './formSchemas';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const [register, { validate, getFieldsValue, setFieldsValue, resetFields }] = useForm({
        ...
        schemas: moneyOutSchemas,
      });

      const [MoneyInModal, { setModalProps, closeModal }] = useModalInner((data) => {
        resetFields();
      ...
      const handleOk = async () => {
        try {
          ...
          const response = await UcardMoneyOut({
            id: currentID.value,

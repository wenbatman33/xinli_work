...
<script setup lang="ts">
	...
	import type { AGENCYAJAX_AgencyActivitysListResponseData } from '@/api/model';
	import { getAgencyActivitysList } from '@/api';

	const tableDataRef = ref<Array<AGENCYAJAX_AgencyActivitysListResponseData>>([]);
	...
	onMounted(() => {
		getAgencyActivitysList().then((res) => {
			loading.value = true;

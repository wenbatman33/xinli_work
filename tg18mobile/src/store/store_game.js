...
export default {
  ...
  actions: {
    ...
    API_PopularGameList({ commit }) {
      axios.post(`${process.env.VUE_APP_APIHOST}/Web_Page/PopularGame`)
        .then((res) => {
    ...
    API_GameList({ commit, rootState }, payload) {
      ...
      axios.post(`${process.env.VUE_APP_APIHOST}/Web_Page/GameList`, payload)
        .then((res) => {
          if (typeof res.data.data.data_list === 'undefined') {
            commit('game/setGameList', res.data.data, { root: true });
          } else {
            commit('game/setGameList', res.data.data.data_list, { root: true });
          }
    ...
    API_GameTagList({ commit }, payload) {
      axios.post(`${process.env.VUE_APP_APIHOST}/Web_Page/GameTagList`, payload)
        .then((res) => {
    ...
    GamesJackpot({ commit }) {
      axios.post(`${process.env.VUE_APP_APIHOST}/Web_Page/Jackpot/Group`)
        .then((res) => {

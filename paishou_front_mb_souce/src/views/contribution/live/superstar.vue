...
van-pull-refresh(v-model='state.isLoading', @refresh='refresh')
    .contribution-live-superstar
        ...
        //- 貢獻榜列表
        contribution-list.mt-4(:list='state.contributionList', type='live', path='superstar')
</template>
<script>
import { reactive, onMounted } from 'vue';
import { contributionLiveSuperstar } from '@/api';

...
van-pull-refresh(v-model='state.isLoading', @refresh='refresh')
    .contribution-live-popular
        //- 報表類型選擇
        type-picker(icon='/publicAssets/img/contribution/mic-g40@3x.png', title='人气主播排行榜', :selected='state.type', @update:selected='updateType')

        //- 貢獻榜列表
        contribution-list.mt-4(:list='state.contributionList', type='live', path='popular')
</template>
<script>
import { reactive, onMounted } from 'vue';
import { contributionLivePopular } from '@/api';

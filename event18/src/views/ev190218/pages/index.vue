            ...
            li.col-12.col-lg-4.px-3(v-for='(item, index) in recordData.bonus.week1')
              ...
              .evTable02Content
                .evComplete(v-if='item[0] != 0 && item[1] != 0')
                  ...
                  a.evCompleteBtn01(v-if='item[0] == 1' href='https://tiger-co-brand.18luckportal.biz/?eventid=77' target='_block') 18新利领奖
                .evTask
                  .evDate
                    .evDateTigerAll
                      img(src='/static/ev190218/logo_18Tiger.png')
  ...
  methods: {
    ...
    viewRewards(Type, Num) {
      ...
      this.propsData = {
        ...
        Target: this.recordData.daily.week1[Num].target,
        Type,
      ...
      if (Num === 0) {
        this.propsData.AwardSite = this.awardSiteHostOne[0];
      } else if (Num === 2) {
        this.propsData.AwardSite = this.awardSiteHostOne[1];
      } else if (Num === 4) {
        this.propsData.AwardSite = this.awardSiteHostOne[2];
      } else if (Num === 6) {
        this.propsData.AwardSite = this.awardSiteHostOne[3];
      }

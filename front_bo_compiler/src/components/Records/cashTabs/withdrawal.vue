<template lang="pug">
  .container-fluid
    .d-flex.justify-content-between.align-items-center
      ...
      div
        span.mx-3 提款总额：{{ total.paymentSumAmount | formatMoney }}
        span.mx-3 最高金额：{{ total.paymentMaxAmount | formatMoney }}
        span.mx-3 提款次数：{{ total.paymentCompletedCnt }}
    ...
    el-table(:data="tableData" height="calc(100vh - 580px)")
      ...
      el-table-column(v-if="fieldPerms.memberBankCardCode" label="银行", prop="memberBankCardCode", align="center")
      el-table-column(v-if="fieldPerms.memberBankCardAccount" label="姓名", prop="memberBankCardAccount", align="center")
      el-table-column(v-if="fieldPerms.memberBankCardNo" label="帳號", prop="memberBankCardNo", align="center")
      ...
      el-table-column(v-if="fieldPerms.transDepAllNote" label="備註", prop="transDepAllNote", align="center")
</template>

<template lang="pug">
  .container-fluid
    ...
    el-table(:data="tableData" height="calc(100vh - 580px)")
      ...
      el-table-column(v-if="fieldPerms.memberFullAddress" label="寄送地址", prop="memberFullAddress", align="center")
      el-table-column(v-if="fieldPerms.promotionDetailUpdatedAt" label="更新日期", prop="promotionDetailUpdatedAt", align="center")
      el-table-column(v-if="fieldPerms.promotionDetailNote" label="备注", prop="promotionDetailNote", align="center")
</template>

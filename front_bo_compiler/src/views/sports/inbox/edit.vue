...
export default {
  ...
  methods: {
    initInbox(inbox) {
      this.id = inbox.id;
      this.formData.inbox_type = inbox.inboxPEType ? inbox.inboxPEType.value : 1;
      this.formData.scheduled_at = inbox.inboxPEScheduledAt;
      this.formData.target = 'account';
      this.formData.account = inbox.memberUserAccount.display;
      this.formData.title = inbox.inboxPETitle;
      this.formData.content = inbox.inboxPEContent;
    },
    handleSubmit() {

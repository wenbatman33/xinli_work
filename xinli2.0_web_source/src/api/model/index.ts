...
export interface AGENCYAJAX_GetDepositResponseData {
  id?: number /* 線路 ID */
  name?: string /* 線路名稱 */
  note?: string /* 說明 */
  icon?: string /* Icon */
...
export interface AGENCYAJAX_CreateWithdrawalRequest {
  type?: number /* 提領方式 1:銀行卡 2:USDT-ERC 3:USDT-TRC */
  id?: number /* 提領地址 or 提領銀行卡 id */
  amount?: number /* 提款金額 */
}

export interface AGENCYAJAX_GetDepositResponse {
  list?: Array<AGENCYAJAX_GetDepositResponseData> /* 列表 */
  exchangeRateERC?: number /* ERC20 存款參考匯率 */
  exchangeRateTRC?: number /* TRC20 存款參考匯率 */
}

export interface AGENCYAJAX_CreateDepositResponse {
  id?: string /* 存款訂單 id */
  cashierType?: number /* 訂單顯示類型[1:R5-1 站內顯示銀行卡資訊, 2:R5-2-A 站內顯示 QR Code(無銀行卡), 3:R5-2-B 站內顯示 QR Code(有銀行卡), 4:R5-3 跳轉三方出納台] */
  payAmount?: number /* 充值金額 */
  bankName?: string /* 銀行名稱 */
  bankcard?: string /* 收款卡號 or 目標錢包 */
  bankcardOwner?: string /* 收款戶名 */
  prompt?: string /* 附言 */
  url?: string /* QRCODE URL或三方出納台URL */
}

export interface AGENCYAJAX_WithdrawalIndexResponse {
  exchangeRateERC?: number /* ERC20 存款參考匯率 */
  exchangeRateTRC?: number /* TRC20 存款參考匯率 */
  withdrawalBankcardMaintain?: boolean /* 銀行卡提款是否維護 [true 維護] */
  withdrawalUsdtMaintain?: boolean /* USDT 提款是否維護 [true 維護] */
  withdrawalECnyMaintain?: boolean /* 數位人民幣是否維護 [true 維護] */
}
...
export interface AGENCYAJAX_AgencyFinanceProductsRequest {
  startOfMonth?: string /* 查詢月份第一天 */
  endOfMonth?: string /* 查詢月份最後一天 */
}

export interface AGENCYAJAX_AgencyFinanceProductRequest {
  id?: number /* 廠商id */
  periodOption?: number /* 日期區間選擇 1:本月 2:昨日 3:今日 */
}
...
export interface AGENCYAJAX_AgencyFinanceProductResponse {
  ...
  volume?: number
  income?: number
  memberList?: Array<AGENCYAJAX_FinanceProductMemberDTO> /* 會員投注資訊 */
}

export interface AGENCYAJAX_FinanceProductMemberDTO {
  account?: string
  volume?: number
  income?: number
}
...
export interface AGENCYAJAX_GetMemberGTO {
  id?: number
  name?: string
...
export interface AGENCYAJAX_GetMembersResponse {
  list?: Array<AGENCYAJAX_GetMemberGTO> /* 代理會員列表 */
  counts?: number
}
...
export interface AGENCYAJAX_ChildAgencyCommissionListData {
  ...
  toParentChildCommission?: number /* 二代佣金 */
}
...
export interface AGENCYAJAX_AgencyHomePageRequest {}
...
export interface AGENCYAJAX_AgencyFinanceGetPlatformFeeRequest {
  periodStart?: string /* 開始時間 */
  periodEnd?: string /* 結束時間 */
}
...
export interface AGENCYAJAX_MemberFinanceDTO {
  id?: number
  name?: string
  volume?: number
  income?: number
...
export interface AGENCYAJAX_ActiveMemberDTO {
...
export interface AGENCYAJAX_GetMemberFinanceResponse {
  memberAccount?: string
  createdAt?: string
  rechargeAmount?: number /* 存款 */
  volume?: number /* 流水 */
  income?: number /* 輸贏 */
  bonus?: number /* 紅利 */
  productList?: Array<AGENCYAJAX_MemberFinanceDTO> /* 產品列表 */
}

export interface AGENCYAJAX_AgencyFinanceIndexRequest {
  periodOption?: number /* 時間區間選項(1.本月 2.上個月) */
}
...
export interface AGENCYAJAX_AgencyDepositListRequest {
  startTime?: string /* 時間區間開始 */
  endTime?: string /* 時間區間結束 */
}

export interface AGENCYAJAX_AgencyDepositListResponse {
  list?: Array<AGENCYAJAX_AgencyDepositListResponseData> /* 列表 */
  count?: number /* 總數 */
}

export interface AGENCYAJAX_AgencyDepositListResponseData {
  amount?: number /* 充值金額 */
...
export interface AGENCYAJAX_AgencyToMemberDepositListResponse {
  list?: Array<AGENCYAJAX_AgencyToMemberDepositListResponseData> /* 列表 */
  count?: number /* 總數 */
}

export interface AGENCYAJAX_AgencyToMemberDepositListResponseData {
  amount?: number /* 充值金額 */
  status?: number /* 狀態[1:處理中 2:失敗 3:完成 4:逾時] */
  statusStr?: string /* 狀態[成功,失败,等待中] */
  id?: string /* 訂單號 */
...
export interface AGENCYAJAX_AgencyWithdrawalListRequest {
  startTime?: string /* 時間區間開始 */
  endTime?: string /* 時間區間結束 */
}

export interface AGENCYAJAX_AgencyWithdrawalListResponse {
  list?: Array<AGENCYAJAX_AgencyWithdrawalListResponseData> /* 列表 */
  count?: number /* 總數 */
}

export interface AGENCYAJAX_AgencyWithdrawalListResponseData {
  amount?: number /* 提款金額 */
...
export interface AGENCYAJAX_AgencyManualOperaionRequest {
  memberID?: string /* 會員帳號 */
  amount?: number /* 轉帳金額 */
}

export interface AGENCYAJAX_AgencyWalletManualOperationRecordDTO {
  memberAccount?: string
  amount?: number
  transferTime?: string
}

export interface AGENCYAJAX_AgencyWalletResponse {
  walletBalance?: number
  transferRecordList?: Array<AGENCYAJAX_AgencyWalletManualOperationRecordDTO>
}

export interface AGENCYAJAX_AgencyCreateMemberBankCardRequest {
  memberID?: number /* 會員ID */
...
export interface AGENCYAJAX_AgencyGetMemberBankCardDTO {
  id?: number /* ID */
  memberID?: number /* 會員ID */
  bankAccount?: string /* 戶名 */
  bankCode?: string /* 開戶行 */
...
export interface AGENCYAJAX_AgencyGetMemberBankCardRequest {
  memberID?: number /* 會員ID */
}

export interface AGENCYAJAX_AgencyGetMemberBankCardResponse {
  list?: Array<AGENCYAJAX_AgencyGetMemberBankCardDTO> /* 會員銀行卡 */
}

export interface AGENCYAJAX_ApplyChildAgencyRequest {
  childAgencyId?: number /* 二級代理ID */
}

export interface AGENCYAJAX_ChildAgencyApplyRequest {
  account?: string /* 代理帳號 */
}

export interface AGENCYAJAX_ChildApplyListResponse {
  list?: Array<AGENCYAJAX_ChildApplyListResponseData> /* 清單 */
}

export interface AGENCYAJAX_ChildApplyListResponseData {
  childAgencyId?: number /* 二級代理ID */
  account?: string /* 帳號 */
  applyTime?: string /* 申請時間 */
  reviewTime?: string /* 審核時間 */
  remark?: string /* 審核備註 */
  auditStatus?: number /* 狀態[1:待審核2:同意3:拒絕] */
}
...
export interface BACKENDAJAX_GetMemberSystemConfigResponse {
  ...
  withdrawalBankcardMaintain?: boolean /* 提款-銀行卡維護 */
  withdrawalUsdtMaintain?: boolean /* 提款-USDT維護 */
  withdrawalECnyMaintain?: boolean /* 提款-數字人民幣維護 */
}
...
export interface BACKENDAJAX_PromotionCondListResponseData {
  ...
  orderNo?: number /* 回饋排序 */
  beforeApply?: number /* 審核標的，為申請前最後一次執行的行為[1是2否] */
}
...
export interface BACKENDAJAX_PromotionMemberApproveListResponse {
  promotionName?: string /* 優惠名稱 */
  batchCycle?: string /* 派發週期 */
  list?: Array<BACKENDAJAX_PromotionMemberApproveListResponseData> /* 優惠手動審核列表 */
}
...
export interface BACKENDAJAX_GetBalanceResponse {
  result?: string
}
...
export interface BACKENDAJAX_PromotionMemberApproveListResponseData {
  ID?: number /* ID */
  memberAccount?: string /* 會員帳號 */
  bonus?: number /* 派發紅利 */
  amount?: number /* 審核內容(實際) */
  status?: number /* 審核狀態 */
...
export interface BACKENDAJAX_PromotionMemberApproveListRequest {
  promotionID?: number /* 優惠流水號 */
  batchID?: number /* 批次流水號 */
  page?: number /* 第幾頁 */
  pageSize?: number /* 每頁筆數 */
...
export interface BACKENDAJAX_AgencyMoneyLogData {
  id?: number /* 流水號 */
  useType?: number /* 類型 */
  amount?: number /* 金額 */
  date?: string /* 時間 */
  afterMoney?: number /* 錢包餘額 */
  remark?: string /* 備註 */
}
...
export interface BACKENDAJAX_CreateAgencyAnnouncementRequest {
  ...
  status?: number /* 狀態 1. 顯示 2. 隱藏 */
  sort?: number /* 順序 數字越小越前面，最小為0 */
  startTime?: string /* 公告上架時間 */
  endTime?: string /* 公告下架時間 */
  imagePc?: string /* PC圖片 */
  imageH5?: string /* H5圖片 */
}
...
export interface BACKENDAJAX_GetAgencyRecordResponse {
  money?: number /* 代理錢包餘額 */
  frozenMoney?: number /* 代理凍結金額 */
  rechargeAmount?: number /* 存款金額 */
  withdrawAmount?: number /* 提款金額 */
  commission?: number /* 佣金派發 */
  transferMember?: number /* 會員轉帳 */
  manualRecharge?: number /* 手動上分 */
  manualWithdraw?: number /* 手動下分 */
  bonusAmount?: number /* 領取優惠 */
}

export interface BACKENDAJAX_GetAgnecyMoneyLogResponse {
  list?: Array<BACKENDAJAX_AgencyMoneyLogData> /* 代理詳細--錢包記錄 */
  count?: number /* 總筆數 */
}
...
export interface BACKENDAJAX_TestRecalcReportRequest {
  startTime?: string /* 開始時間 */
  endTime?: string /* 結束時間 */
...
export interface BACKENDAJAX_GetChannelDayReconciliationRequest {
  ...
  serviceCode?: string /* 支付方式: [ali:支付宝,wx:微信,usdt:USDT,union:银联,sp:快捷,gw:网关,attm:代理存給會員] */
  payChannelNameID?: number /* 商戶id */
...
export interface EVENTAJAX_RegisterRequest {
  memberID?: number /* 會員ID */
}

export interface EVENTAJAX_GetEvent0002ResponseData {
  registerAt?: string /* 註冊時間 */
  deadline?: string /* 截止時間 */
  bankcardCert?: number /* 銀行卡狀態[1綁定2未綁定] */
  phoneCert?: number /* 驗證手機號[1驗證2未驗證] */
  registerBonusStatus?: number /* 註冊禮包[1領取2未領取] */
  totalLoss?: number /* 累計負盈利 */
  returnBonus?: number /* 返利禮包金額 */
}

export interface EVENTAJAX_GetEvent0002SignResponseData {
  date?: string /* 日期 */
  signStatus?: number /* 簽到狀態[1簽到2未簽到] */
}
...
export interface GAMEAJAX_getStakeStatisticsResponse {
  list?: Array<GAMEAJAX_getStakeStatisticsResponseData> /* 遊戲列表 */
  count?: number /* 總筆數 */
}
...
export interface GAMEAJAX_getStakeStatisticsRequest {
  memberID?: number /* 會員id */
}

export interface GAMEAJAX_getStakeStatisticsResponseData {
  gameType?: string /* 遊戲類型 */
  gameAgency?: string /* 遊戲代理商 */
  betAmount?: string /* 有效流水 */
  winAmount?: string /* 輸贏(公司) */
}
...
export interface MEMBERAJAX_GetVipGiftResponse {
  ...
  summery?: Array<MEMBERAJAX_GetVipGiftSummeryData> /* 返水統計資訊 */
}

export interface MEMBERAJAX_GetVipGiftSummeryData {
  gameType?: number /* 返水遊戲類型 1:體育 2:真人 3:彩票 4:電競 5:電子 */
  percent?: number /* 最高返水比例 */
  money?: number /* 發放總金額 */
}
...
export interface MEMBERAJAX_GetVipInfoResponse {
  ...
  lastSatisfyTime?: string /* 最後保級成功時間 */
  current?: MEMBERAJAX_VIPLevelInfoResponseData
  next?: MEMBERAJAX_VIPLevelInfoResponseData
}

export interface MEMBERAJAX_TakeVIPGiftByTypeRequest {
  type?: number /* 返水遊戲類型 1:體育 2:真人 3:彩票 4:電競 5:電子 */
}

export interface MEMBERAJAX_GetVipSettingResponse {
  list?: Array<MEMBERAJAX_VIPLevelInfoResponseData> /* VIP資訊 */
}

export interface MEMBERAJAX_GetVipGiftRequest {
  type?: number /* 禮金類型  1:月礼金,2:晉級,3:週年,4:返水,5:生日礼 */
  gameType?: number /* 返水遊戲類型 1:體育 2:真人 3:彩票 4:電競 5:電子 */
}
...
export interface MEMBERAJAX_GetMemberResponse {
  ...
  otherBankCardName?: string /* 他人銀行卡的實名 */
}
...
export interface PAYMENTAJAX_IDResponse {
  id?: string /* id */
}
...
export interface PAYMENTAJAX_GetDepositDetailRequest {
  id?: string /* id */
}

export interface PAYMENTAJAX_GetDepositDetailResponse {
  cashierType?: number /* 訂單顯示類型[1:R5-1 站內顯示銀行卡資訊, 2:R5-2-A 站內顯示 QR Code(無銀行卡), 3:R5-2-B 站內顯示 QR Code(有銀行卡), 4:R5-3 跳轉三方出納台] */
  effectiveTime?: number /* 有效充值時間: 若超過指定時間，訂單失效] */
  id?: string /* 訂單編號 */
  payAmount?: number /* 實際支付金額 */
  amount?: number /* 充值金額 */
  bankName?: string /* 銀行名稱 */
  bankcard?: string /* 收款卡號 */
  bankcardOwner?: string /* 收款戶名 */
  prompt?: string /* 附言 */
  payChannelName?: string /* 充值渠道 */
  targetWallet?: string /* 目標錢包 */
  url?: string /* QRCODE URL或三方出納台URL */
}
...
export interface REPORTAJAX_TestRecalcReportRequest {
  startTime?: string /* 開始時間 */
  endTime?: string /* 結束時間 */
  isFinal?: boolean /* 是否為最後結算 */
}
...
export interface SwaggerApi{
  /**
   * @tag AGENCYAJAX.record
   * @summary 交易紀錄：充值紀錄
   */
  get(url: "/agency/record/deposit", options: {query: {
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<AGENCYAJAX_AgencyDepositListResponse>

  /**
   * @tag AGENCYAJAX.record
   * @summary 交易紀錄：上分給會員
   */
  get(url: "/agency/record/deposit_to_member", options: {query: {
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<AGENCYAJAX_AgencyToMemberDepositListResponse>

  /**
   * @tag AGENCYAJAX.record
   * @summary 交易紀錄：提款紀錄
   */
  get(url: "/agency/record/withdrawal", options: {query: {
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<AGENCYAJAX_AgencyWithdrawalListResponse>
   ...
   * @summary 存款： 建立存款單
   */
  post(url: "/agency/deposit", options: {body: AGENCYAJAX_CreateDepositRequest} & IDefaultOptions): Promise<AGENCYAJAX_CreateDepositResponse>
   ...
   * @summary 提款: 申請提款
   */
  post(url: "/agency/withdrawal", options: {body: AGENCYAJAX_CreateWithdrawalRequest} & IDefaultOptions): Promise<AGENCYAJAX_EmptyResponse>
   ...
   * @summary 代理財物報表
   */
  get(url: "/agency/agency/finance", options: {query: {
    periodOption: number
  }} & IDefaultOptions): Promise<AGENCYAJAX_AgencyFinanceIndexResponse>
   ...
   * @summary 單一產品分項報表
   */
  get(url: "/agency/agency/finance/product", options: {query: {
    id: number
    periodOption: number
  }} & IDefaultOptions): Promise<AGENCYAJAX_AgencyFinanceProductResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 代理會員列表 會員存提記錄與輸贏
   */
  get(url: "/agency/agency/members", options: {query: {
    periodStart?: string
    periodEnd?: string
  }} & IDefaultOptions): Promise<AGENCYAJAX_GetMembersResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 單一產品會員流水與輸贏
   */
  get(url: "/agency/agency/member", options: {query: {
    id: number
    periodStart: string
    periodEnd: string
  }} & IDefaultOptions): Promise<AGENCYAJAX_GetMemberFinanceResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 代理會員單一廠商流水與輸贏
   */
  get(url: "/agency/agency/member/product", options: {query: {
    memberID: number
    gameGroupID: number
    periodStart?: string
    periodEnd?: string
  }} & IDefaultOptions): Promise<AGENCYAJAX_GetMemberProductFinanceResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 財務報表活躍用戶
   */
  get(url: "/agency/agency/finance/activemember", options: {query: {
    id: number
    periodOption: number
  }} & IDefaultOptions): Promise<AGENCYAJAX_AgencyFinanceGetActivememberResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 財務報表紅利
   */
  get(url: "/agency/agency/finance/bonus", options: {query: {
    periodStart: string
    periodEnd: string
  }} & IDefaultOptions): Promise<AGENCYAJAX_AgencyFinanceGetBonusResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 財務報表平台費
   */
  get(url: "/agency/agency/finance/platform", options: {query: {
    periodStart: string
    periodEnd: string
  }} & IDefaultOptions): Promise<AGENCYAJAX_AgencyFinanceGetPlatformResponse>
   ...
   * @summary 代理錢包/餘額
   */
  get(url: "/agency/agency/wallet/balance", options?: {} & IDefaultOptions): Promise<AGENCYAJAX_AgencyWalletResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 代理手動上下分
   */
  post(url: "/agency/agency/wallet/manualoperation", options: {body: AGENCYAJAX_AgencyManualOperaionRequest} & IDefaultOptions): Promise<AGENCYAJAX_EmptyResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 取得二級代理申請進度
   */
  get(url: "/agency/agency/child/applies", options?: {} & IDefaultOptions): Promise<AGENCYAJAX_ChildApplyListResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 取得銀行卡
   */
  get(url: "/agency/agency/backcard", options: {query: {
    memberID: number
  }} & IDefaultOptions): Promise<AGENCYAJAX_AgencyGetMemberBankCardResponse>

  /**
   * @tag AGENCYAJAX.agency
   * @summary 申請二級代理進度
   */
  post(url: "/agency/agency/child/apply", options: {body: AGENCYAJAX_ChildAgencyApplyRequest} & IDefaultOptions): Promise<AGENCYAJAX_EmptyResponse>

  /**
   * @tag BACKENDAJAX.MemberDetailLogs
   * @summary 用戶列表操作紀錄
   */
  get(url: "/backend/memberdetaillogs/logs", options: {query: {
    page?: number
    pageSize?: number
    memberAccount?: string
    startDate?: string
    endDate?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetMemberDetailLogsResponse>

  /**
   * @tag BACKENDAJAX.pay.pay_channel
   * @summary 商戶號管理: 商戶號列表
   */
  get(url: "/backend/pay/pay_channel", options: {query: {
    sn?: string
    status?: number
    name?: string
    supplyAp?: boolean
    sort?: string
    dir?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetPayChannelResponse>
   ...
   */
  get(url: "/backend/pay/pay_channel/show", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PayChannelResponseData>

  /**
   * @tag BACKENDAJAX.pay.pay_channel
   * @summary 商戶號管理: 取得銀行卡號 / 商戶號資訊
   */
  get(url: "/backend/pay/pay_channel/search", options: {query: {
    keyword: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_PayChannelSearchResponse>
   ...
   * @summary 商戶號管理: 帳務明細
   */
  get(url: "/backend/pay/pay_channel/log", options: {query: {
    ...
    dir?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetPayChannelAmountLogResponse>
   ...
   * @summary 商戶號管理: 查詢餘額
   */
  post(url: "/backend/pay/pay_channel/balance", options: {body: BACKENDAJAX_IDRequest} & IDefaultOptions): Promise<BACKENDAJAX_GetBalanceResponse>

  /**
   * @tag BACKENDAJAX.pay_bankcard
   * @summary 銀行卡明細：帳務明細
   */
  get(url: "/backend/pay_bankcard/log", options: {query: {
    logTimeStart?: string
    logTimeEnd?: string
    cardNo?: number
    orderBy?: number
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_BankcardLogListResponse>
   ...
   */
  get(url: "/backend/report/deposit/people_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    serviceCode?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_DepositPeopleSummaryResponse>
   ...
   */
  get(url: "/backend/report/deposit/people_week_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    serviceCode?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_DepositPeopleSummaryResponse>
   ...
   */
  get(url: "/backend/report/deposit/people_month_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    serviceCode?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_DepositPeopleSummaryResponse>
   ...
   * @summary 取得會員存款報表
   */
  get(url: "/backend/report/deposit/member_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    currency?: number
    paymentGroup?: string
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_MemberDepositSummaryResponse>
   ...
   * @summary 系統站內信：列表
   */
  get(url: "/backend/site/letter/setting/list", options: {query: {
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetLetterSettingResponse>

  /**
   * @tag BACKENDAJAX.site
   * @summary 站內信發送清單：列表
   */
  get(url: "/backend/site/letter/list", options: {query: {
    memberAccount?: string
    status?: number
    type?: number
    title?: string
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetLetterListResponse>

  /**
   * @tag BACKENDAJAX.site
   * @summary 站內信發送清單：發送名單
   */
  get(url: "/backend/site/letter/member", options: {query: {
    letterSettingId: number
    memberAccount?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetLetterMemberResponse>
   ...
   * @summary 系統站內信：編輯
   */
  get(url: "/backend/site/letter/setting", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_LetterSettingResponseData>
   ...
   * @summary 站內信發送清單：編輯
   */
  get(url: "/backend/site/letter/member/one", options: {query: {
    letterSettingId: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_LetterListResponseData>
   ...
   */
  get(url: "/backend/report/withdraw/people_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_WithdrawPeopleSummaryResponse>
   ...
   */
  get(url: "/backend/report/withdraw/people_week_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_WithdrawPeopleSummaryResponse>
   ...
   */
  get(url: "/backend/report/withdraw/people_month_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_WithdrawPeopleSummaryResponse>
   ...
   * @summary 代理公告列表
   */
  get(url: "/backend/agency/announcement/list", options: {query: {
    periodBeginning: string
    periodEnd: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyAnnouncementResponse>
   ...
   */
  get(url: "/backend/agency/walletlogs/withdrawallist", options: {query: {
    page?: number
    pageSize?: number
    agencyID: number
    inOut?: number
    ...
    orderBy?: string
    sortBy?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyWalletLogsForWithdrawalResponse>

  /**
   * @tag BACKENDAJAX.promotion.launched
   * @summary 優惠：取得單一上架優惠
   */
  get(url: "/backend/promotion/launched", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionLaunchedListResponseData>
   ...
   */
  get(url: "/backend/promotion/launched/list", options: {query: {
    name?: string
    type?: number
    display?: number
    device?: number
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionLaunchedListResponse>

  /**
   * @tag BACKENDAJAX.pay_bankcard
   * @summary 銀行卡管理：查看銀行卡資料API
   */
  get(url: "/backend/pay_bankcard", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_BankcardListResponseData>
   ...
   */
  get(url: "/backend/pay_bankcard/bankcards", options: {query: {
    cardNo?: number
    status?: number
    type?: number
    accountName?: string
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_BankcardListResponse>
   ...
   * @summary 取得預設銀行卡
   */
  get(url: "/backend/agency/bankcard/getdefault", options: {query: {
    agencyID: number
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AgencyBankCardData>

  /**
   * @tag BACKENDAJAX.agency.bankCard
   * @summary 取得代理銀行卡列表
   */
  get(url: "/backend/agency/bankcard/list", options: {query: {
    agencyID: number
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AgencyBankCardListResponse>
   ...
   * @summary 取得遊戲廠商
   */
  get(url: "/backend/game/gamegroup", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GameGroupDataResponse>
   ...
   * @summary 取得遊戲廠商list
   */
  get(url: "/backend/game/gamegroup/list", options: {query: {
    name?: string
    displayName?: string
    gameAgencyID?: number
    walletType?: number
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetGameGroupListResponse>
   ...
   * @summary 取得會員USDT
   */
  get(url: "/backend/member/usdts", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetMemberUSDTResponse>
   ...
   * @summary 刪除會員USDT
   */
  delete(url: "/backend/member/usdt", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   */
  get(url: "/backend/member/walletlogs/withdrawallist", options: {query: {
    page?: number
    pageSize?: number
    memberID: number
    inOut?: number
    ...
    orderBy?: string
    sortBy?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetMemberWalletLogsForWithdrawalResponse>

  /**
   * @tag BACKENDAJAX.agency
   * @summary 取得代理列表
   */
  get(url: "/backend/agency/list", options: {query: {
    agencyID?: number
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyListResponse>

  /**
   * @tag BACKENDAJAX.agency
   * @summary 取得代理詳細
   */
  get(url: "/backend/agency", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AgencyDataResponse>
   ...
   */
  get(url: "/backend/agency/checkmember", options: {query: {
    account: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_CheckMemberByAccountResponse>
   ...
   * @summary 取得代理佣金群組
   */
  get(url: "/backend/agency/rankgroup", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyRankGroupResponse>
   ...
   * @summary 刪除推廣網址
   */
  delete(url: "/backend/agency/promotionlink", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_UpdateAgencyResponse>
   ...
   * @summary 查詢代理的上層代理資訊
   */
  get(url: "/backend/agency/node", options: {query: {
    agencyAccount: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyNodeResponse>
   ...
   * @summary 代理詳細-數據相關
   */
  get(url: "/backend/agency/getrecord", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyRecordResponse>

  /**
   * @tag BACKENDAJAX.agency
   * @summary 代理詳細-錢包近期記錄
   */
  get(url: "/backend/agency/getrecentmoneylog", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgnecyMoneyLogResponse>
   ...
   * @summary 查詢VIP禮品紀錄
   */
  get(url: "/backend/vip/gift/search", options: {query: {
    page?: number
    pageSize?: number
    id?: number
    account?: string
    ...
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_SearchVIPGiftResponse>
   ...
   * @summary 刪除USDT位址
   */
  delete(url: "/backend/agency/usdt", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_UpdateAgencyUsdtResponse>

  /**
   * @tag BACKENDAJAX.agency.usdt
   * @summary 取得預設USDT
   */
  get(url: "/backend/agency/usdt/getdefault", options: {query: {
    agencyID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AgencyUsdtData>

  /**
   * @tag BACKENDAJAX.agency.usdt
   * @summary 取得代理USDT列表
   */
  get(url: "/backend/agency/usdt/list", options: {query: {
    agencyID: number
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AgencyUsdtListResponse>
   ...
   * @summary 取得代理等級群組
   */
  get(url: "/backend/agency/ranksetting", options: {query: {
    groupID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AgencyRankSettingDataResponse>
   ...
   * @summary 取得代理等級群組
   */
  get(url: "/backend/agency/ranksetting/list", options: {query: {
    groupName?: string
    groupID?: number
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyRankSettingListResponse>
   ...
   * @summary 申請單詳細
   */
  get(url: "/backend/agency/childapplication", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_ChildAgencyApplicationDataResponse>
   ...
   * @summary 申請單列表
   */
  get(url: "/backend/agency/childapplication/list", options: {query: {
    agencyID?: number
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetChildAgencyApplicationListResponse>
   ...
   * @summary 確認代理資料
   */
  get(url: "/backend/agency/childapplication/checkagency", options: {query: {
    account: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_CheckAgencyResponse>

  /**
   * @tag BACKENDAJAX.site
   * @summary 公告: 列表
   */
  get(url: "/backend/site/announcement", options: {query: {
    title?: string
    hidden?: boolean
    sort?: string
    dir?: string
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAnnouncementResponse>
   ...
   * @summary 公告: 刪除
   */
  delete(url: "/backend/site/announcement", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_SuccessResponse>
   ...
   */
  get(url: "/backend/finance", options: {query: {
    status?: number
    maintain?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_FinanceListResponse>
   ...
   */
  get(url: "/backend/finance/search/channel", options: {query: {
    financeID: number
    name?: string
    status?: number
    serviceCode?: string
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PayChannelServiceListResponse>
   ...
   */
  get(url: "/backend/finance/edit", options: {query: {
    id: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_FinanceListResponseData>
   ...
   */
  delete(url: "/backend/finance/delete", options: {query: {
    financeID: number
    payChannelServiceID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_SuccessResponse>
   ...
   */
  delete(url: "/backend/finance/finance_delete", options: {query: {
    financeID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_SuccessResponse>
   ...
   * @summary 代理活動列表
   */
  get(url: "/backend/agency/activity/list", options: {query: {
    periodBeginning: string
    periodEnd: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyActivityResponse>

  /**
   * @tag BACKENDAJAX.agency.activity
   * @summary 代理活動
   */
  get(url: "/backend/agency/activity", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AgencyActivityDTO>
   ...
   * @summary 修改代理活動
   */
  put(url: "/backend/agency/activity/edit", options: {body: BACKENDAJAX_UpdateAgencyActivityRequest} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>

  /**
   * @tag BACKENDAJAX.member
   * @summary 取得會員銀行卡
   */
  get(url: "/backend/member/bankcards", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetMemberBankCardResponse>
   ...
   * @summary 刪除會員銀行卡
   */
  delete(url: "/backend/member/bankcard", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   * @summary 取得代理申請列表
   */
  get(url: "/backend/agency/application/list", options: {query: {
    isFuzzy?: boolean
    auditStatus?: number
    id?: string
    agencyAccount?: string
    ...
    pageSize?: number
    page?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyApplicationsByAdditionResponse>

  /**
   * @tag BACKENDAJAX.agency.application
   * @summary 取得代理申請詳細
   */
  get(url: "/backend/agency/application", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyApplicationResponse>
  ...
  /**
   * @tag BACKENDAJAX.report.tool
   * @summary 重算基本報表game
   */
  get(url: "/backend/report/tool/recalcreportmemberdailygame", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   * @summary 重算基本報表
   */
  get(url: "/backend/report/tool/recalcreportmemberdaily", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   * @summary 重算代理生涯報表
   */
  get(url: "/backend/report/tool/recalcreportagencycareerdaily", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
  ...
  /**
   * @tag BACKENDAJAX.report.tool
   * @summary 重算全部基本報表-基本報表、基本報表GAME、會員生涯、代理生涯
   */
  get(url: "/backend/report/tool/recalcreportmemberall", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   * @summary 重算代理佣金報表
   */
  get(url: "/backend/report/tool/recalcagentcommissionmonthly", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   * @summary 確認會員資料
   */
  get(url: "/backend/member/node/checkmember", options: {query: {
    account: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_MemberNodeMemberDetailResponse>

  /**
   * @tag BACKENDAJAX.member.node
   * @summary 確認代理資料
   */
  get(url: "/backend/member/node/checkagency", options: {query: {
    account: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_MemberNodeAgencyDetailResponse>

  /**
   * @tag BACKENDAJAX.member.node
   * @summary 取得會員換線列表
   */
  get(url: "/backend/member/node/list", options: {query: {
    memberID?: number
    agencyID?: number
    agencyAccount?: string
    exactlyMatching?: number
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_MemberNodeLogListResponse>

  /**
   * @tag BACKENDAJAX.report.channel
   * @summary 取得進款統計報表
   */
  get(url: "/backend/report/channel/deposit", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    ...
    serviceCode?: string
    payChannelServiceID?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_ChannelDepositSummaryMapResponse>
   ...
   * @summary 取得單一線路進款表
   */
  get(url: "/backend/report/channel/single_channel_deposit", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    reportHourStart?: number
    reportHourEnd?: number
    serviceCode?: string
    payChannelServiceID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_ChannelDepositSummaryResponse>
   ...
   * @summary 取得商戶號每日對帳表
   */
  get(url: "/backend/report/channel/day_reconciliation", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    reportHourStart?: number
    reportHourEnd?: number
  ...
  }} & IDefaultOptions): Promise<BACKENDAJAX_ChannelReconciliationReportResponse>
   ...
   * @summary 取得三方整點對帳表
   */
  get(url: "/backend/report/channel/hour_reconciliation", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    reportHourStart: number
    reportHourEnd: number
    ...
    balanceDiff?: number
    balanceChange?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_ChannelReconciliationReportMapResponse>
   ...
   * @summary 存款管理: 存款單列表
   */
  get(url: "/backend/pay/deposit", options: {query: {
    source?: number
    createdAtStart?: string
    createdAtEnd?: string
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetDepositResponse>
   ...
   * @summary 存款管理: 查看訂單紀錄
   */
  get(url: "/backend/pay/deposit/note", options: {query: {
    id: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetPayNoteResponse>
   ...
   * @summary 取得遊戲代理商
   */
  get(url: "/backend/game/gameagency", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetGameAgencyResponse>
   ...
   * @summary 取得遊戲代理商列表
   */
  get(url: "/backend/game/gameagency/list", options: {query: {
    name?: string
    gameTypeID?: number
    status?: number
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetGameAgencyListResponse>
   ...
   */
  get(url: "/backend/withdrawal", options: {query: {
    source?: number
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetWithdrawalIndexResponse>
   ...
   */
  get(url: "/backend/withdrawal/member/info", options: {query: {
    id: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetMemberWithdrawalInfoResponse>

  /**
   * @tag BACKENDAJAX.withdrawal
   * @summary 提款管理: 提款審核單流水資料
   */
  get(url: "/backend/withdrawal/betting", options: {query: {
    id: number
    startTime: string
    endTime: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetWithdrawalBettingLogResponse>

  /**
   * @tag BACKENDAJAX.withdrawal
   * @summary 提款管理：取得審核詳細資料-代理提款
   */
  get(url: "/backend/withdrawal/agency/info", options: {query: {
    id: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyWithdrawalInfoResponse>
   ...
   */
  get(url: "/backend/withdrawal/payout/info", options: {query: {
    orderSn: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetWithdrawalPayoutResponse>

  /**
   * @tag BACKENDAJAX.withdrawal
   * @summary 提款管理: 查看訂單紀錄
   */
  get(url: "/backend/withdrawal/note", options: {query: {
    id: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetPayNoteResponse>
   ...
   * @summary 取得遊戲
   */
  get(url: "/backend/game/gamelist", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GameListDataResponse>
   ...
   * @summary 取得遊戲list
   */
  get(url: "/backend/game/gamelist/list", options: {query: {
    gameGroupID?: number
    gameTypeID?: number
    name?: string
    displayName?: string
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetGameListResponse>
   ...
   * @summary 檢查代理錢包資料
   */
  get(url: "/backend/agencywallet/manualoperation/checkagencywallet", options: {query: {
    agencyID?: number
    agencyAccount?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_CheckAgencyWalletResponse>

  /**
   * @tag BACKENDAJAX.agencyWallet.manualOperation
   * @summary 取得代理詳細
   */
  get(url: "/backend/agencywallet/manualoperation", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AgencyWalletManualOperationListDetailData>

  /**
   * @tag BACKENDAJAX.agencyWallet.manualOperation
   * @summary 建立代理手動上下分申請單
   */
  post(url: "/backend/agencywallet/manualoperation", options: {body: BACKENDAJAX_CreateAgencyWalletManualOperationRequest} & IDefaultOptions): Promise<BACKENDAJAX_AgencyWalletManualOperationResponse>

  /**
   * @tag BACKENDAJAX.agencyWallet.manualOperation
   * @summary 核准
   */
  put(url: "/backend/agencywallet/manualoperation/permit", options: {body: BACKENDAJAX_AgencyWalletManualOperationPermitRequest} & IDefaultOptions): Promise<BACKENDAJAX_AgencyWalletManualOperationResponse>

  /**
   * @tag BACKENDAJAX.agencyWallet.manualOperation
   * @summary 拒絕
   */
  put(url: "/backend/agencywallet/manualoperation/deny", options: {body: BACKENDAJAX_AgencyWalletManualOperationPermitRequest} & IDefaultOptions): Promise<BACKENDAJAX_AgencyWalletManualOperationResponse>

  /**
   * @tag BACKENDAJAX.agencyWallet.manualOperation
   * @summary 取得代理列表
   */
  get(url: "/backend/agencywallet/manualoperation/list", options: {query: {
    agencyID?: number
    agencyAccount?: string
    exactlyMatching?: number
    type?: number
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AgencyWalletManualOperationListResponse>

  /**
   * @tag BACKENDAJAX.admin.role
   * @summary 取得群組 id 有哪些對應的功能
   */
  get(url: "/backend/admin/role/roles", options: {query: {
    roleID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetRoleFnsResponse>
   ...
   * @summary 取得後台群組列表
   */
  get(url: "/backend/admin/role/adminroles", options: {query: {
    page?: number
    pageSize?: number
    roleName?: string
    note?: string
    status?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAdminRolesResponse>
   ...
   * @summary 取得群組成員列表
   */
  get(url: "/backend/admin/role/adminusers", options: {query: {
    roleID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAdminUsersByRoleIDResponse>
   ...
   */
  delete(url: "/backend/admin/role/adminuser", options: {query: {
    adminID: number
    roleID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   */
  get(url: "/backend/pay_channel_service", options: {query: {
    name?: string
    status?: number
    serviceCode?: string
    bankGroupID?: number
   ...
   */
  get(url: "/backend/pay_channel_service/edit", options: {query: {
    id: number
    type?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PayChannelServiceListResponseData>
   ...
   */
  get(url: "/backend/pay_channel_service/groups/exclude", options: {query: {
    id: number
    type?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PayGroupListResponseData>
   ...
   */
  get(url: "/backend/report/deposit/amount_range_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    serviceCode?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_DepositAmountSummaryResponse>
   ...
   * @summary 取得週存款報表，以人數統計
   */
  get(url: "/backend/report/deposit/amount_range_week_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    serviceCode?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_DepositAmountSummaryResponse>
   ...
   * @summary 取得月存款報表，以人數統計
   */
  get(url: "/backend/report/deposit/amount_range_month_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
    serviceCode?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_DepositAmountSummaryResponse>
   ...
   */
  get(url: "/backend/report/withdraw/amount_range_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_WithdrawAmountSummaryResponse>
   ...
   * @summary 取得週提款報表，以人數統計
   */
  get(url: "/backend/report/withdraw/amount_range_week_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_WithdrawAmountSummaryResponse>
   ...
   * @summary 取得月提款報表，以人數統計
   */
  get(url: "/backend/report/withdraw/amount_range_month_report", options: {query: {
    reportDateStart: string
    reportDateEnd: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_WithdrawAmountSummaryResponse>
   ...
   * @summary 優惠：取得單一優惠模板
   */
  get(url: "/backend/promotion/cond", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionCondListResponseData>
   ...
   * @summary 優惠：刪除優惠單一模板
   */
  delete(url: "/backend/promotion/cond", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_SuccessResponse>
   ...
   * @summary 優惠：優惠模板列表
   */
  get(url: "/backend/promotion/cond/list", options: {query: {
    promotionID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionCondListResponse>

  /**
   * @tag BACKENDAJAX.promotion.cond
   * @summary 優惠：刪除指定優惠與類型的多個模板
   */
  delete(url: "/backend/promotion/cond/conds", options: {query: {
    promotionID: number
    type: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_SuccessResponse>
   ...
   * @summary 優惠：取得單一優惠
   */
  get(url: "/backend/promotion", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionListResponseData>
   ...
   * @summary 優惠：刪除優惠
   */
  delete(url: "/backend/promotion", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_SuccessResponse>
   ...
   * @summary 優惠:優惠列表
   */
  get(url: "/backend/promotion/list", options: {query: {
    ID?: number
    name?: string
    startTime?: string
    endTime?: string
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionListResponse>

  /**
   * @tag BACKENDAJAX.promotion
   * @summary 優惠:排除優惠選單
   */
  get(url: "/backend/promotion/exclude", options: {query: {
    ID?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionListResponse>
   ...
   * @summary 手動上下分列表
   */
  get(url: "/backend/adjustment/list", options: {query: {
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAdjustmentListResponse>
   ...
   * @summary 刪除手動調整單
   */
  delete(url: "/backend/adjustment/delete", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   * @summary 手動上下分會員申請清單
   */
  get(url: "/backend/adjustment/search", options: {query: {
    memberName?: string
    reason?: number
    status?: number
  ...
  }} & IDefaultOptions): Promise<BACKENDAJAX_SearchMemberAdjustmentResponse>
   ...
   * @summary 取得會員備註
   */
  get(url: "/backend/member/comments", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetMemberCommentResponse>
   ...
   * @summary 取得會員簡易備註
   */
  get(url: "/backend/member/comments/brief", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetMemberCommentResponse>
   ...
   * @summary 刪除群組功能內容
   */
  delete(url: "/backend/admin/function/function", options: {query: {
    fnID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   * @summary 取得已設定群組功能列表
   */
  get(url: "/backend/admin/function/functions", options: {query: {
    page?: number
    pageSize?: number
    fnID?: number
    fnName?: string
    fnKey?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetFunctionsResponse>

  /**
   * @tag BACKENDAJAX.authLogs
   * @summary 取得後台權限管理的操作紀錄
   */
  get(url: "/backend/authlogs/logs", options: {query: {
    page?: number
    pageSize?: number
    account?: string
    startDate?: string
    endDate?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAuthLogsResponse>
   ...
   * @summary 流水總覽
   */
  get(url: "/backend/bettinglog/search", options: {query: {
    page?: number
    pageSize?: number
    memberAccount?: string
    gameListID?: number
    ...
    settlementTimeEnd?: string
    betLogStatus?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetBettingLogResponse>

  /**
   * @tag BACKENDAJAX.bettinglog
   * @summary 流水詳情
   */
  get(url: "/backend/bettinglog/search/summery", options: {query: {
    memberID: number
    settlementTimeStart?: string
    settlementTimeEnd?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetStakeDetailResponse>

  /**
   * @tag BACKENDAJAX.bettinglog
   * @summary zanderTest1取得流水
   */
  get(url: "/backend/bettinglog/test", options: {query: {
    page?: number
    pageSize?: number
    memberID: number
    gameListID: number
    ...
    settlementTimeStart?: string
    settlementTimeEnd?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetBettingLogTestIResponse>
   ...
   */
  get(url: "/backend/agency/commission/list", options: {query: {
    date: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyCommissionResponse>

  /**
   * @tag BACKENDAJAX.agency.commission
   * @summary 取得指定月份的二代佣金列表
   */
  get(url: "/backend/agency/commission/childlist", options: {query: {
    date: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAgencyCommissionChildResponse>
   ...
   * @summary 廣告分類: 列表
   */
  get(url: "/backend/site/banner/category", options: {query: {
    sort?: string
    dir?: string
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetBannerCategoryResponse>
   ...
   * @summary 廣告: 列表
   */
  get(url: "/backend/site/banner", options: {query: {
    title?: string
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetBannerResponse>
   ...
   * @summary 廣告: 刪除
   */
  delete(url: "/backend/site/banner", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_SuccessResponse>
   ...
   * @summary 優惠列表：操作記錄
   */
  get(url: "/backend/promotion/log/list", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionLogsResponse>

  /**
   * @tag BACKENDAJAX.pay_group
   * @summary 金流組別（三方）：取得單一組別
   */
  get(url: "/backend/pay_group/group", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PayGroupListResponseData>
   ...
   */
  get(url: "/backend/pay_group/groups", options: {query: {
    type: number
    name?: string
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PayGroupListResponse>
   ...
   * @summary 刪除通知設定
   */
  delete(url: "/backend/notification", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_EmptyResponse>
   ...
   * @summary U帳戶管理: 列表API
   */
  get(url: "/backend/pay/usdt", options: {query: {
    name?: string
    useType?: number
    type?: number
    status?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetUSDTListResponse>
   ...
   */
  get(url: "/backend/pay/usdt/log", options: {query: {
    createdAtStart: string
    createdAtEnd: string
    usdtID?: number
    dir?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetUSDTLogResponse>
   ...
   * @summary 優惠:批次派發列表
   */
  get(url: "/backend/promotion/member", options: {query: {
    promotionID?: number
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionMemberBatchListResponse>

  /**
   * @tag BACKENDAJAX.promotion.member
   * @summary 優惠:申請清單
   */
  get(url: "/backend/promotion/member/list", options: {query: {
    promotionID?: number
    promotionName?: string
    batchID?: number
    memberID?: number
    ...
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionMemberListResponse>

  /**
   * @tag BACKENDAJAX.promotion.member
   * @summary 優惠:提供會員在指定時間內領取的優惠資訊
   */
  get(url: "/backend/promotion/member/withdrw", options: {query: {
    memberID: number
    startTime: string
    endTime: string
    promotionCondType?: number
    status?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionForWithdrawResponse>

  /**
   * @tag BACKENDAJAX.promotion.member
   * @summary 優惠:手動審核列表
   */
  get(url: "/backend/promotion/member/approve", options: {query: {
    promotionID: number
    batchID: number
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_PromotionMemberApproveListResponse>

  /**
   * @tag BACKENDAJAX.promotion.member
   * @summary 優惠:手動審核列表-操作
   */
  post(url: "/backend/promotion/member/approve", options: {body: BACKENDAJAX_PromotionMemberApproveRequest} & IDefaultOptions): Promise<BACKENDAJAX_SuccessResponse>
   ...
   */
  get(url: "/backend/admin/user/roles", options: {query: {
    adminID?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetRoleResponse>

  /**
   * @tag BACKENDAJAX.admin.user
   * @summary 取得登入者的可用權限功能
   */
  get(url: "/backend/admin/user/fns", options: {query: {
    adminID?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAdminFunctionsResponseData>

  /**
   * @tag BACKENDAJAX.admin.user
   * @summary 取得指定後台帳號 adminID 資訊
   */
  get(url: "/backend/admin/user/admin", options: {query: {
    adminID?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_AdminUserResponseData>
   ...
   */
  get(url: "/backend/admin/user/admins", options: {query: {
    page?: number
    pageSize?: number
    adminID?: number
    account?: string
    ...
    roleID?: number
    status?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetAdminUsersResponse>
   ...
   * @summary 取得會員標籤
   */
  get(url: "/backend/member/tag", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetMemberTagResponse>
   ...
   * @summary 搜尋會員
   */
  get(url: "/backend/member/search", options: {query: {
    page?: number
    pageSize?: number
    id?: number
    account?: string
  ...
  }} & IDefaultOptions): Promise<BACKENDAJAX_SearchMemberResponse>

  /**
   * @tag BACKENDAJAX.member
   * @summary 取得會員詳細資料
   */
  get(url: "/backend/member/detail", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetMemberDetailResponse>
   ...
   * @summary 取得會員錢包統計資料
   */
  get(url: "/backend/member/detail/money", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_MemberMoneySummeryResponse>

  /**
   * @tag BACKENDAJAX.member
   * @summary 取得會員提款資料
   */
  get(url: "/backend/member/detail/withdraw", options: {query: {
    id: number
    start?: string
    end?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_MemberDepositWithdrawResponse>
   ...
   * @summary 會員明細-廠商流水資料
   */
  get(url: "/backend/member/stake/statistics", options?: {} & IDefaultOptions): Promise<BACKENDAJAX_getStakeStatisticsResponse>

  /**
   * @tag BACKENDAJAX.member.login.log
   * @summary 搜尋會員
   */
  get(url: "/backend/member/login/log/search", options: {query: {
    page?: number
    pageSize?: number
    account?: string
    loginIP?: string
  ...
  }} & IDefaultOptions): Promise<BACKENDAJAX_SearchLoginLogResponse>

  /**
   * @tag BACKENDAJAX.risk
   * @summary 初審模組 - 會員列表
   */
  get(url: "/backend/risk/member/list", options: {query: {
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetRiskMemberResponse>
   ...
   * @summary 使用過此IP的會員
   */
  get(url: "/backend/risk/ip/list", options: {query: {
    page?: number
    pageSize?: number
    ip: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetRiskIpResponse>

  /**
   * @tag BACKENDAJAX.risk
   * @summary 使用過此裝置的會員
   */
  get(url: "/backend/risk/device/list", options: {query: {
    page?: number
    pageSize?: number
    device: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_GetRiskDeviceResponse>

  /**
   * @tag BACKENDAJAX.risk
   * @summary 會員同裝置
   */
  get(url: "/backend/risk/search", options: {query: {
    page?: number
    pageSize?: number
    memberName?: string
    deviceID?: string
  }} & IDefaultOptions): Promise<BACKENDAJAX_SearchMemberDeviceGhostResponse>
   ...
   * @summary 取得廣告
   */
  get(url: "/event/banner", options: {query: {
    categortyID: number
  }} & IDefaultOptions): Promise<EVENTAJAX_GetBannerResponse>

  /**
   * @tag EVENTAJAX.letter
   * @summary 會員站內信
   */
  get(url: "/event/letter/list", options: {query: {
    page?: number
    pageSize?: number
  }} & IDefaultOptions): Promise<EVENTAJAX_GetLetterResponse>

  /**
   * @tag EVENTAJAX.letter
   * @summary 單一站內信
   */
  get(url: "/event/letter", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<EVENTAJAX_GetLetterResponseData>

  /**
   * @tag EVENTAJAX.letter
   * @summary 刪除站內信
   */
  delete(url: "/event/letter", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<EVENTAJAX_CommonSuccessResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/imtrade/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>

  /**
   * @tag GAMEAJAX.IMTrade
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/imtrade/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/bl/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/bl/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 注單列表
   */
  get(url: "/game/log/list", options: {query: {
    page?: number
    pageSize?: number
    memberID?: number
    memberAccount?: string
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<GAMEAJAX_GetGameLogResponse>

  /**
   * @tag GAMEAJAX.log
   * @summary 老虎機注單詳情
   */
  get(url: "/game/log/slot/list", options: {query: {
    page?: number
    pageSize?: number
    memberID?: number
    memberAccount?: string
    ...
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<GAMEAJAX_GetSlotLogListResponse>

  /**
   * @tag GAMEAJAX.log
   * @summary 電競體育類注單詳情
   */
  get(url: "/game/log/esport/list", options: {query: {
    page?: number
    pageSize?: number
    memberID?: number
    memberAccount?: string
    ...
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<GAMEAJAX_GetESportLogListResponse>

  /**
   * @tag GAMEAJAX.log
   * @summary 彩票類注單詳情
   */
  get(url: "/game/log/lottery/list", options: {query: {
    page?: number
    pageSize?: number
    memberID?: number
    memberAccount?: string
    ...
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<GAMEAJAX_GetLotteryLogListResponse>

  /**
   * @tag GAMEAJAX.log
   * @summary 補魚類注單詳情
   */
  get(url: "/game/log/fish/list", options: {query: {
    page?: number
    pageSize?: number
    memberID?: number
    memberAccount?: string
    ...
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<GAMEAJAX_GetFishLogListResponse>

  /**
   * @tag GAMEAJAX.log
   * @summary 體育類注單詳情
   */
  get(url: "/game/log/sport/list", options: {query: {
    page?: number
    pageSize?: number
    memberID?: number
    memberAccount?: string
    ...
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<GAMEAJAX_GetSportLogListResponse>

  /**
   * @tag GAMEAJAX.IM
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/im/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/im/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   */
  get(url: "/game/game/balance/single", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<GAMEAJAX_GetBalanceResponseData>

  /**
   * @tag GAMEAJAX.game
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/game/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/game/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 從遊戲廠商取得遊戲列表
   */
  get(url: "/game/gamelist/getbygroupid", options: {query: {
    gameGroupID: number
  }} & IDefaultOptions): Promise<GAMEAJAX_GetGameListByGroupIDResponse>
   ...
   * @summary 取得使用者收藏遊戲
   */
  get(url: "/game/gamelist/getfavoritegame", options: {query: {
    gameTypeID: number
  }} & IDefaultOptions): Promise<GAMEAJAX_GetMemberFavoriteGameListResponse>

  /**
   * @tag GAMEAJAX.gamelist
   * @summary 取得熱門遊戲(pc)
   */
  get(url: "/game/gamelist/hotgame/pc", options: {query: {
    gameTypeID?: number
    gameGroupID?: number
  }} & IDefaultOptions): Promise<GAMEAJAX_GetHotGameResponse>

  /**
   * @tag GAMEAJAX.gamelist
   * @summary 取得熱門遊戲(h5)
   */
  get(url: "/game/gamelist/hotgame/h5", options: {query: {
    gameTypeID?: number
    gameGroupID?: number
  }} & IDefaultOptions): Promise<GAMEAJAX_GetHotGameResponse>
   ...
   * @summary 取消收藏此遊戲
   */
  delete(url: "/game/gamelist/unlike", options: {query: {
    gameListID: number
  }} & IDefaultOptions): Promise<GAMEAJAX_EmptyResponse>

  /**
   * @tag GAMEAJAX.gamelist
   * @summary 取得最近遊玩遊戲
   */
  get(url: "/game/gamelist/playedgame", options: {query: {
    gameTypeID?: number
    gameGroupID?: number
  }} & IDefaultOptions): Promise<GAMEAJAX_GetHotGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/ebet/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/ebet/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/bg/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/bg/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/xg/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/xg/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/cr/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/cr/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/kg/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/kg/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/pg/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/pg/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/ag/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/ag/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/nw/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/nw/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/cq9/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/cq9/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/hl/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/hl/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/lb/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/lb/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址
   */
  get(url: "/game/saba/login", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 登入遊戲取得網址(舊版)
   */
  get(url: "/game/saba/login/old", options: {query: {
    gameListID: string
  }} & IDefaultOptions): Promise<GAMEAJAX_BaseLoginGameResponse>
   ...
   * @summary 取得城市
   */
  get(url: "/member/region/cities", options: {query: {
    upid: number
  }} & IDefaultOptions): Promise<MEMBERAJAX_RegionResponse>

  /**
   * @tag MEMBERAJAX.region
   * @summary 取得區域
   */
  get(url: "/member/region/state", options: {query: {
    upid: number
  }} & IDefaultOptions): Promise<MEMBERAJAX_RegionResponse>
   ...
   * @summary 取得街區
   */
  get(url: "/member/region/street", options: {query: {
    upid: number
  }} & IDefaultOptions): Promise<MEMBERAJAX_RegionResponse>
   ...
   * @summary 取得VIP資訊
   */
  get(url: "/member/vip/setting", options?: {} & IDefaultOptions): Promise<MEMBERAJAX_GetVipSettingResponse>

  /**
   * @tag MEMBERAJAX.vip
   * @summary 取得VIP可領取資訊
   */
  get(url: "/member/vip/gift", options: {query: {
    type?: number
    gameType?: number
  }} & IDefaultOptions): Promise<MEMBERAJAX_GetVipGiftResponse>
  ...
  /**
   * @tag MEMBERAJAX.vip
   * @summary 領取VIP禮金(依照類型)
   */
  post(url: "/member/vip/gift/type", options: {body: MEMBERAJAX_TakeVIPGiftByTypeRequest} & IDefaultOptions): Promise<MEMBERAJAX_EmptyResponse>
   ...
   * @summary 刪除會員銀行卡
   */
  delete(url: "/member/member/bankcard", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<MEMBERAJAX_EmptyResponse>
   ...
   * @summary 刪除會員USDT
   */
  delete(url: "/member/member/usdt", options: {query: {
    id: number
  }} & IDefaultOptions): Promise<MEMBERAJAX_EmptyResponse>
   ...
   * @summary 發送訊息
   */
  get(url: "/member/sms/send", options: {query: {
    phone: string
  }} & IDefaultOptions): Promise<MEMBERAJAX_EmptyResponse>
   ...
   * @summary 驗證驗證碼
   */
  post(url: "/member/sms/verify", options: {body: MEMBERAJAX_MemberVerifySmsRequest} & IDefaultOptions): Promise<MEMBERAJAX_MemberVerifySmsResponse>
   ...
   * @summary 新註冊會員加入金流群組
   */
  get(url: "/payment/pay_group/register", options: {query: {
    memberID: number
  }} & IDefaultOptions): Promise<PAYMENTAJAX_mixed>
   ...
   * @summary 優惠活動：列表
   */
  get(url: "/payment/promotion", options: {query: {
    type: number
  }} & IDefaultOptions): Promise<PAYMENTAJAX_PromotionListResponse>

  /**
   * @tag PAYMENTAJAX.promotion
   * @summary 優惠活動：單則優惠內容
   */
  get(url: "/payment/promotion/one", options: {query: {
    ID: number
  }} & IDefaultOptions): Promise<PAYMENTAJAX_PromotionListResponseData>
   ...
   * @summary 交易紀錄：紅利紀錄
   */
  get(url: "/payment/record/bonus", options: {query: {
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<PAYMENTAJAX_BonusListResponse>

  /**
   * @tag PAYMENTAJAX.record
   * @summary 交易紀錄：充值紀錄
   */
  get(url: "/payment/record/deposit", options: {query: {
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<PAYMENTAJAX_DepositListResponse>

  /**
   * @tag PAYMENTAJAX.record
   * @summary 交易紀錄：提款紀錄
   */
  get(url: "/payment/record/withdrawal", options: {query: {
    startTime?: string
    endTime?: string
  }} & IDefaultOptions): Promise<PAYMENTAJAX_WithdrawalListResponse>
   ...
   * @summary 存款：單筆充值單資訊
   */
  get(url: "/payment/deposit/detail", options: {query: {
    id: string
  }} & IDefaultOptions): Promise<PAYMENTAJAX_GetDepositDetailResponse>
   ...
   * @summary 提款: 提款送出
   */
  post(url: "/payment/withdrawal", options: {body: PAYMENTAJAX_CreateWithdrawalRequest} & IDefaultOptions): Promise<PAYMENTAJAX_IDResponse>
   ...
   */
  get(url: "/report/report/lock", options: {query: {
    customerID?: number
    sleep?: number
  }} & IDefaultOptions): Promise<REPORTAJAX_EmptyResponse>

  /**
   * @tag REPORTAJAX.report
   * @summary 測試用-測試 URI parameter 功能
   */
  get(url: "/report/report/{channelsn}/{ordersn}/{amount}/callback", options: {query: {
    customerID?: number
    sleep?: number
  }} & IDefaultOptions): Promise<REPORTAJAX_ArrayResponse>

  /**
   * @tag REPORTAJAX.report
   * @summary 測試基本報表game
   */
  get(url: "/report/report/testreportmemberdailygame", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<REPORTAJAX_ArrayResponse>
   ...
   * @summary 測試基本報表
   */
  get(url: "/report/report/testreportmemberdaily", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<REPORTAJAX_ArrayResponse>
   ...
   * @summary 測試代理生涯報表
   */
  get(url: "/report/report/testreportagencycareerdaily", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<REPORTAJAX_EmptyResponse>
   ...
   * @summary 測試基本報表全部
   */
  get(url: "/report/report/testreportmemberall", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<REPORTAJAX_EmptyResponse>
   ...
   * @summary 測試代理佣金報表
   */
  get(url: "/report/report/testagentcommissionmonthly", options: {query: {
    startTime: string
    endTime: string
    isFinal?: boolean
  }} & IDefaultOptions): Promise<REPORTAJAX_EmptyResponse>
   ...
   * @summary 測試產生會員
   */
  get(url: "/report/report/testgenmember", options: {query: {
    accountPrefix?: string
    promotionLink?: string
  }} & IDefaultOptions): Promise<REPORTAJAX_GenMemberResponse>

  /**
   * @tag REPORTAJAX.report
   * @summary 測試產生代理
   */
  get(url: "/report/report/testgenagency", options: {query: {
    accountPrefix?: string
    parentAgencyID?: number
  }} & IDefaultOptions): Promise<REPORTAJAX_GenAgencyResponse>

  /**
   * @tag REPORTAJAX.report
   * @summary 測試批次產生總代、下層代理跟所屬會員
   */
  get(url: "/report/report/testbatchgenagencymember", options: {query: {
   ...
   */
  get(url: "/report/report/testgenfakememberreport", options: {query: {
    date: string
    parentAgencyAccount: string
    rechargeAmount?: number
    withdrawAmount?: number
   ...
   */
  get(url: "/report/report/testadjustrelation", options: {query: {
    parentAgencyAccount: string
    date: string
  }} & IDefaultOptions): Promise<REPORTAJAX_EmptyResponse>
  ...
  /**
   * @tag REPORTAJAX.report
   * @summary 測試-強制把代理密碼都改成qwer1234
   */
  get(url: "/report/report/testforcechangeagencypassword", options?: {} & IDefaultOptions): Promise<REPORTAJAX_EmptyResponse>
}

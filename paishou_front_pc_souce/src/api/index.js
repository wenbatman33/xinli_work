...
// 创建开播 V2
export const createRoomV2 = (payload) => axios.post('/live/v2/create', payload);
// 关播
...
// 推荐直播列表
export const recommendV2 = (payload) => axios.get('/live/v2/recommend', { params: payload });
// 赛程列表
...
// 礼物列表
export const giftlist = (payload) => axios.get('/live/giftlist', { params: payload });
// 背包送禮 香蕉
export const sendGift = (payload) => axios.post('/live/sendgift', payload);
// 赠送礼物
export const sendGiftBackpack = (payload) => axios.post('/live/sendgift/backpack', payload);

// 直播間禮物列表  20210331 新增
export const giftlistV2 = (payload) => axios.get('/gift/list', { params: payload });
// 送禮 20210331 新增
...
// 推薦紀錄，顯示用戶推薦領取獎勵的紀錄
export const inviteList = (payload) => axios.get('/users/invite/list', { params: payload });
// 刪除站内信
...
// 主播 人气主播榜
export const livePopular = (payload) => axios.get('/contribution/live/popular', { params: payload });
// 主播 超级明星榜
export const liveSuperStar = (payload) => axios.get('/contribution/live/superstar', { params: payload });
// 用户 富豪贡献榜
export const userRich = (payload) => axios.get('/contribution/user/rich', { params: payload });
// 用户 超級明星榜
export const userSuperStar = (payload) => axios.get('/contribution/user/superstar', { params: payload });
...
// 主播角色获取管理员列表
export const adminListByHost = (payload) => axios.get('/live/room/manager', { params: payload });
// 用户名添加管理员
export const addAdminListByHost = (payload) => axios.post('/live/manager', payload);

// 用暱稱搜尋用戶
export const userNameSearch = (payload) => axios.get('/user/name/search', { params: payload });

// 主播角色获取u禁封成员列表
export const banListByHost = (payload) => axios.get('/users/ban/list', { params: payload });
// 获取管理员列表
export const banCancelByHost = (payload) => axios.post('/users/ban/cancel', payload);
...
// 上传图片
export const uploadFile = (payload) => axios.post('/upload/file', payload);
// 获取个人资料
...
// ----------------------------------------------------------------------------------------------------------
export const getUserNotification = (payload) => axios.get('/user/notification');
// 聖誕節活動----------------------------------------------------------------------------------------------------------
// 取得聖誕節活動抽獎次數
export const xmaxBonusCount = (payload) => axios.get('/event/xmax/bonus/count', { params: payload });
// 購買聖誕節活動抽獎次數
export const xmaxBonusBuy = (payload) => axios.post('/event/xmax/bonus/buy', payload);
// 抽聖誕節活動轉盤獎項
export const playXmaxBonus = (payload) => axios.get('/event/xmax/bonus', { params: payload });
// ----------------------------------------------------------------------------------------------------------
// 新年活動----------------------------------------------------------------------------------------------------------
// 取得新年活動基本訊息
export const newyearInfo = (payload) => axios.get('/event/newyear', { params: payload });
// 骰新年活動骰子
export const newyearBonus = (payload) => axios.post('/event/newyear/bonus', payload);
// 購買新年活動骰子次數
export const newyearBonusBuy = (payload) => axios.post('/event/newyear', payload);

// 新年活動排行榜
export const newyearLeaderboard = (payload) => axios.get('/event/newyear/leaderboard', { params: payload });
// 取得新年活動獎勵列表
export const newyearRemain = (payload) => axios.get('/event/newyear/remain', { params: payload });
// 骰新年活動骰子獎勵兌換
export const newyearExchange = (payload) => axios.post('/event/newyear/exchange', payload);
// ----------------------------------------------------------------------------------------------------------
// 購買五萬元大禮包
export const newyear5million = (payload) => axios.post('/event/newyear/5million', payload);
// ----------------------------------------------------------------------------------------------------------
// 活動分類
...
// 直播間/競猜資訊API
export const guessRecommend = (payload) => axios.get('/guess/recommend', { params: payload });
// 主播建立競猜活動
...
// 個人/主播/競猜中心：主播取消競猜
export const guessCancel = (payload) => axios.post('/guess/cancel', payload);
// ----------------------------------------------------------------------------------------------------------
// 文章分類列表
export const articleClass = (payload) => axios.get('/article/class', { params: payload });
// 分類底下的文章
...
// ----------------------------------------------------------------------------------------------------------
// 直播間相關賽事
export const liveRoomLike = (payload) => axios.get('/live/room/like', { params: payload });
// ----------------------------------------------------------------------------------------------------------
// 賽事活動API
export const competitionCollaboration = (payload) => axios.get('/competition/get_collaboration', { params: payload });
// ----------------------------------------------------------------------------------------------------------
// 競猜資訊API for 東奧

	...
	.w-full.h-full.p-4.relative
		...
		.flex.justify-around.my-2
			.CENTER_C.truncate(class='w-1/3')
				...
				.w-full.home.font-bold.text-center.truncate(v-if='scheduleData.homescore') {{scheduleData.homescore}}
			.CENTER_C(class='w-1/3')
				...
				h2.text-gray-500(v-if='checkGameTime(scheduleData)==="none"') {{scheduleData.begin1}}
			.CENTER_C.truncate(class='w-1/3')
				...
				.w-full.away.font-bold.text-center.truncate(v-if='scheduleData.awayscore') {{scheduleData.awayscore}}

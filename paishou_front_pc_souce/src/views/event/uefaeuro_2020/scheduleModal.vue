...
a-modal(:visible='show', :closable='false', :footer='null')
	...
	.w-full.FLEX_C.pb-8
		//- 關閉按鈕
		a-button.self-end.w-8.h-8.p-1(type='link', @click='clickClose')

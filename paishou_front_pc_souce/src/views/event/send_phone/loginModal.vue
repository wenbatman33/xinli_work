...
a-modal(:visible='show', :closable='false', :footer='null')
    .FLEX_C.items-center.px-6.py-8
        ...
        .w-full.grid.grid-cols-2.gap-4.mt-6
            //- 關閉
            a-button.w-auto.h-auto.px-4.py-2.rounded-full.shadow.border-transparent.bg-transparent(ghost, @click='clickClose')
                .text-sm.text-close 关闭

            //- 登入
            a-button.w-auto.h-auto.px-4.py-2.rounded-full.shadow.border-transparent.bg-login(@click='clickLogin')
